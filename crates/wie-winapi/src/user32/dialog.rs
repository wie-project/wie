...
fn resolve_template(
    ...
    template_id
        .and_then(|id| find_template(&dialogs, id, super::lang::ui_language()))
        .cloned()
...
pub fn handle_send_dlg_item_message_w(ctx: &mut HandlerContext<'_>) -> Result<WinApiHandlerResult> {
    ...
    let long_parameter = read_guest_u64(engine, rsp.wrapping_add(0x28))
    ...
    super::message::handle_send_message(ctx, true, "SendDlgItemMessageW")
}
