...
mod tests {
    use super::{
        DMCOLOR_COLOR, DMORIENT_PORTRAIT, SelectedPathWrite, apply_default_extension, basename_of,
        build_dev_names_bytes, complete_file_dialog, default_dev_mode, dev_mode_seed_ui,
        ...
        is_simple_filter_glob, list_directory, parse_ofn_filter, read_print_dev_mode_seed,
        resolve_initial_dir, split_path_components, write_selected_path,
    };
    ...
    use crate::{
        ...
        FontDialogPolicy, HandlerContext, KernelState, ModuleState, PrintDialogPick,
