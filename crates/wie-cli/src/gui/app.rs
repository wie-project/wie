...
mod input_events;
/// Native-alert helpers for the macOS MessageBox bridge (Win32 MB_*/ID*
/// mapping, parent-window resolution, the no-parent NSAlert fallback).
mod native_dialog;

#[cfg(target_os = "macos")]
pub(crate) use native_dialog::resolve_dialog_parent;
#[cfg(target_os = "macos")]
use native_dialog::show_unparented_ns_alert;
#[cfg(target_os = "macos")]
use native_dialog::{map_alert_result, map_message_box_buttons, order_window_front};
